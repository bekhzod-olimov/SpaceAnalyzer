...
# =================================================================================
UZBEK_TEXT = {
    "loading_model": "YOLO-World modeli yuklanmoqda...",
...
def main():
    ...
    while True:
        ...
        # Heatmap uchun nuqtalarni to'plash
        for detection, class_id in zip(final_detections.xyxy, final_detections.class_id):
        ...
        cv2.imshow("Dynamic Store Analytics (YOLO-World)", annotated_frame)
